...
import UncertainGlitch from "@/components/UncertainGlitch";
import "./globals.css";
          ...
          <div className="footer-inner">
            <div className="footer-grid">
              <div className="footer-lede">
                ...
                <div className="footer-monkey-wrap">
                  <img
                  ...
                  />
                  <span className="footer-monkey-caption" aria-hidden="true">
                    <UncertainGlitch text="Expect the unexpected." />
                  </span>
                </div>
              </div>
              <div className="col">
            ...
            <div className="footer-bottom">
              <span className="mono-up">© Vectors — Julius T. Geiger {new Date().getFullYear()}. All rights reserved.</span>
